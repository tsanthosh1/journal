...
import { Search, Image as ImageIcon, X, Upload, Link2, FolderUp } from "lucide-react";
          ...
          <div className="relative w-full max-w-xl max-h-[85vh] flex flex-col overflow-hidden rounded-2xl border border-white/15 bg-slate-900 shadow-2xl">
            ...
            <div className="flex items-center border-b border-white/10 bg-slate-950/20 px-5 gap-4">
              <button
                ...
                className={`inline-flex items-center gap-1.5 py-2.5 text-xs font-semibold border-b-2 transition cursor-pointer ${
                  activeTab === "search"
            ...
            <div className="p-5 overflow-y-auto flex-1 space-y-4">
              ...
              {activeTab === "upload" && (
                <div className="space-y-4">
                  ...
                  >
                    <FolderUp className="w-8 h-8 text-cyan-400/80 mb-1" />
