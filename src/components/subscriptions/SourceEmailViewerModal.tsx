...
import { Calendar, FileText, CreditCard, AlertTriangle, MessageSquare } from "lucide-react";
          ...
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {cycleMonth && (
                  <span className="inline-flex items-center gap-1 rounded-md bg-indigo-500/20 border border-indigo-500/30 px-2 py-0.5 text-[11px] font-semibold text-indigo-300">
                    <Calendar className="w-3 h-3 text-indigo-400" /> Cycle {formatCycleMonth(cycleMonth)}
                  </span>
                )}
              </div>
              ...
              <>
                ...
                <div className="border-b border-white/10 p-3 sm:p-4 bg-slate-950/20 space-y-2 shrink-0">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <span
                        className={`self-start sm:self-auto inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-semibold ${
                      ...
                      {selectedEmail.isDuplicate && (
                        <span className="inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-semibold bg-amber-500/20 text-amber-300 border border-amber-500/30">
